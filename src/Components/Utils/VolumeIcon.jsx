...
export const MorphingVolIcon = React.memo(
  ({ volume, muted, jumpedToMax, isIncreased, isAnimating }) => {
    ...
    const pathArray = React.useMemo(() => {
      ...
      if (isMuted && !jumpedToMax) return [speakerPath, highWave, mutedPath];
        ...
        >
          ...
          <>
            <motion.path
              ...
              clipPath={
                !isMuted ? "url(#svg-volume-animation-mask)" : undefined
              }
            />
