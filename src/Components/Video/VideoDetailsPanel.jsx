...
const VideoDetailsPanel = ({videoId, data, dataContext, userData, user, isAuthenticated, channelId, channelName, subscriberCount, owner, activeAlertId, setActiveAlertId}) => {
  return (
    <>
